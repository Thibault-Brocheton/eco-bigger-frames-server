...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Borderless Frame Wide Item")]
            public partial class BorderlessFrameWideObject : PictureFrameObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(BorderlessFrameWideItem);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = BorderlessFrameWideItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy BorderlessFrameWide is.
            public partial class BorderlessFrameWideItem : WorldObjectItem<BorderlessFrameWideObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(BorderlessFrameWideObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BorderlessFrameWide".</para>
    ...
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Borderless Frame Wide Item")]
    public partial class BorderlessFrameWideRecipe : RecipeFamily
    {
        public BorderlessFrameWideRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BorderlessFrameWide",  //noloc
                ...
                {
                    new CraftingElement<BorderlessFrameWideItem>()
                });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Borderless Frame Wide"), recipeType: typeof(BorderlessFrameWideRecipe));
            this.ModsPostInitialize();
