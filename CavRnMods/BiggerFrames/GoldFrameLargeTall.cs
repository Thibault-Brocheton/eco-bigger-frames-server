...
namespace Eco.Mods.TechTree
{
            ...
            public partial class GoldFrameLargeTallObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static GoldFrameLargeTallObject()
        {
            WorldObject.AddOccupancy<GoldFrameLargeTallObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = GoldFrameLargeTallItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy GoldFrameLargeTall is.
            public partial class GoldFrameLargeTallItem : WorldObjectItem<GoldFrameLargeTallObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(GoldFrameLargeTallObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "GoldFrameLargeTall".</para>
    ...
    public partial class GoldFrameLargeTallRecipe : Recipe
    {
        public GoldFrameLargeTallRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<GoldFrameLargeTallItem>()
                });
