...
namespace Eco.Mods.TechTree
{
            ...
            public partial class CopperFrameLargeSquareObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static CopperFrameLargeSquareObject()
        {
            WorldObject.AddOccupancy<CopperFrameLargeSquareObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = CopperFrameLargeSquareItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy CopperFrameLargeSquare is.
            public partial class CopperFrameLargeSquareItem : WorldObjectItem<CopperFrameLargeSquareObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(CopperFrameLargeSquareObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CopperFrameLargeSquare".</para>
    ...
    public partial class CopperFrameLargeSquareRecipe : Recipe
    {
        public CopperFrameLargeSquareRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<CopperFrameLargeSquareItem>()
                });
