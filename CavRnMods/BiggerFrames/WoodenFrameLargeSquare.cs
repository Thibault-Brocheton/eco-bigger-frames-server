...
namespace Eco.Mods.TechTree
{
            ...
            public partial class WoodenFrameLargeSquareObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static WoodenFrameLargeSquareObject()
        {
            WorldObject.AddOccupancy<WoodenFrameLargeSquareObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = WoodenFrameLargeSquareItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy WoodenFrameLargeSquare is.
            public partial class WoodenFrameLargeSquareItem : WorldObjectItem<WoodenFrameLargeSquareObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(WoodenFrameLargeSquareObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WoodenFrameLargeSquare".</para>
    ...
    public partial class WoodenFrameLargeSquareRecipe : Recipe
    {
        public WoodenFrameLargeSquareRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<WoodenFrameLargeSquareItem>()
                });
