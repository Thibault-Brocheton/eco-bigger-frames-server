...
namespace Eco.Mods.TechTree
{
            ...
            public partial class OrnateWoodenFrameLargeSquareObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static OrnateWoodenFrameLargeSquareObject()
        {
            WorldObject.AddOccupancy<OrnateWoodenFrameLargeSquareObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = OrnateWoodenFrameLargeSquareItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy OrnateWoodenFrameLargeSquare is.
            public partial class OrnateWoodenFrameLargeSquareItem : WorldObjectItem<OrnateWoodenFrameLargeSquareObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(OrnateWoodenFrameLargeSquareObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "OrnateWoodenFrameLargeSquare".</para>
    ...
    public partial class OrnateWoodenFrameLargeSquareRecipe : Recipe
    {
        public OrnateWoodenFrameLargeSquareRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<OrnateWoodenFrameLargeSquareItem>()
                });
