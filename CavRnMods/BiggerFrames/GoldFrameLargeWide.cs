...
namespace Eco.Mods.TechTree
{
            ...
            public partial class GoldFrameLargeWideObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static GoldFrameLargeWideObject()
        {
            WorldObject.AddOccupancy<GoldFrameLargeWideObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = GoldFrameLargeWideItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy GoldFrameLargeWide is.
            public partial class GoldFrameLargeWideItem : WorldObjectItem<GoldFrameLargeWideObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(GoldFrameLargeWideObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "GoldFrameLargeWide".</para>
    ...
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Gold Frame Large Wide Item")]
    public partial class GoldFrameLargeWideRecipe : Recipe
    {
        public GoldFrameLargeWideRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<GoldFrameLargeWideItem>()
                });
