...
namespace Eco.Mods.TechTree
{
            ...
            public partial class OrnateIronFrameLargeSquareObject : PictureFrameObject, IRepresentsItem
    {
        ...
        static OrnateIronFrameLargeSquareObject()
        {
            WorldObject.AddOccupancy<OrnateIronFrameLargeSquareObject>(new List
                <BlockOccupancy>(){
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = OrnateIronFrameLargeSquareItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy OrnateIronFrameLargeSquare is.
            public partial class OrnateIronFrameLargeSquareItem : WorldObjectItem<OrnateIronFrameLargeSquareObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(OrnateIronFrameLargeSquareObject).UILink(),
    ...
    /// <summary>
    /// <para>Server side recipe definition for "OrnateIronFrameLargeSquare".</para>
    ...
    public partial class OrnateIronFrameLargeSquareRecipe : Recipe
    {
        public OrnateIronFrameLargeSquareRecipe()
        {
            this.Init(
                ...
                {
                    new CraftingElement<OrnateIronFrameLargeSquareItem>()
                });
